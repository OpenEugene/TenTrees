...
namespace OpenEug.TenTrees.Module.Cohort.Services
{
    public class ServerCohortService : ICohortService
    {
        ...
        public Task<string> GetSuggestedNameAsync(int villageId, int year)
        {
        ...
        public Task<Models.GrowerCohort> AddGrowerToCohortAsync(int cohortId, int growerId)
        {
        ...
        public Task RemoveGrowerFromCohortAsync(int cohortId, int growerId)
        {
        ...
        public Task<Models.MentorCohort> AssignMentorToCohortAsync(int cohortId, string mentorId)
        {
        ...
        public Task RemoveMentorFromCohortAsync(int cohortId, string mentorId)
        {
        ...
        public Task RemoveCohortClassAsync(int cohortId, int trainingClassId)
        {
